...
SELECT name FROM sys.schemas WHERE name = 'Reference';
GO

CREATE SCHEMA Recruiter;
GO

SELECT name FROM sys.schemas WHERE name = 'Recruiter';
GO

CREATE SCHEMA Candidate;
GO

SELECT name FROM sys.schemas WHERE name = 'Candidate';
GO
...
VALUES 
    (N'PERMANENT', N'Permanent', N'Ongoing employed role.'),
...
VALUES 
    (N'TECHNOLOGY', N'Technology', N'Software, data and IT roles.'),
...
VALUES 
    (N'Dales Digital Recruitment', N'12 Market Street, The Dales', N'admin@dalesdigital.example', N'TrainingPassword01'),
...
VALUES 
    (1, N'Amelia', N'Brooks', N'Senior Technology Recruiter', N'01908 100001', 1),
...
VALUES 
    (N'jacob.miles@example.com', N'TrainingPassword01'),
...
VALUES 
    (N'ethan.reed@example.com', N'TrainingPassword07', 0);
GO
...
VALUES 
    (1, N'Jacob', N'Miles', N'07700 900001', N'Milton Keynes', N'/cv/jacob-miles.pdf', 1, N'Contractor'),
...
VALUES 
    (7, N'Ethan', N'Reed', N'07700 900007', N'Milton Keynes', N'/cv/ethan-reed.pdf', 0, N'Permanent', 0);
GO
...
VALUES 
    (1, 1, 1, N'JOB-2026-0001', N'Junior SQL Developer',
...
VALUES 
    (1, 1, N'APP-2026-0001', N'I have completed beginner SQL training and want to work with databases.', 0, 2),
